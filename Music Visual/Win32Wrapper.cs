...
namespace Music_Visual
{
    public class W32
    {
        ...
        public static List<string> getChildHandle(IntPtr Handle)
        {
            list.Clear();
            EnumChildWindows(Handle, EnumWindowsMethod, IntPtr.Zero);
        ...
        private static bool EnumWindowsMethod(IntPtr hwnd, IntPtr lParam)
        {
            ...
            GetWindowText((int)hwnd, lpString, 200);//这里获得控件text
